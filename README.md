...
**Debian Buster** Tested with version 20210310 minimal usable ansible version is **2.9.16/2.10.4**. Debian version does not include the stonith configuration and the firewall configuration.
